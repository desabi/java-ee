 ...
 * @author Abi
 */
public class CelularesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            listaCelulares.add("Alcatel");
            listaCelulares.add("HTC");
            listaCelulares.add("ZTE");
            
            request.setAttribute("celulares", listaCelulares);
            
            RequestDispatcher vista = request.getRequestDispatcher("CelularesJSP.jsp");
