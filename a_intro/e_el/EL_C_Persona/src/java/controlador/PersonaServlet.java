...
public class PersonaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {           
            ...
            laPersona.setEdad(Integer.parseInt(edadS));
            laPersona.setTelefono(Long.parseLong(telefonoS));
            
            laDireccion.setEstado(estado);
            laDireccion.setCiudad(ciudad);
            laDireccion.setColonia(colonia);
