...
public class TaxiServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            elChofer.setNombre(nombre);
            elChofer.setTelefono(Long.parseLong(telefonoS));
            
            elTaxi.setSitio(sitio);
            elTaxi.setNumero(Integer.parseInt(numeroS));
            elTaxi.setChofer(elChofer);
            
            request.setAttribute("unTaxi", elTaxi);
            
            RequestDispatcher vista = request.getRequestDispatcher("/TaxiJSP.jsp");
