...
public class PersonaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            /* Poner atributos al request */
            request.setAttribute("elNombre", nombre);
            request.setAttribute("laEdad", edad);
            request.setAttribute("laEstatura", estatura);
            request.setAttribute("elTelefono", telefono);
            
            /* Pasar los datos a la vista: PersonaJSP */
